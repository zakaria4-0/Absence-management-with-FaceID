...
<form action="RegisterServlet" method="post">
   ...
   <header class="head-form">
      ...
      <p>Creat Account using your name email and pasword</p>
   </header>
   <!--     End  header Content  -->
   <br>
   <div class="field-set">
      ...
      <!--   user name -->
        ...
        <!--   user name Input-->
         ...
         <input class="form-input" id="txt-input" type="text" placeholder="@UserEmail format: .p/s@esith.net" name="email" required>
